...
5. **Save**: Once your plan is approved, make an appropriate title and save it to `.opencode/plans/` as a markdown file. **CRITICAL**: Use Serena to write the file, and update any memories relevant to the plan.
