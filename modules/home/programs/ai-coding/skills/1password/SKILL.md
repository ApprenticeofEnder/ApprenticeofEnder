...
name: 1password
description: >
  1Password CLI (op) reference skill. Auth recovery, runtime secret access, op:// config patterns,
  SSH agent setup, git commit signing, and error catalog.
  Use when: op CLI fails, biometric unlock needed, SSH agent not responding, git signing broken,
  setting up op:// references, or any 1Password integration task.
---
