...
description: Conduct an audit of a project's dependencies and package usage.
...
Review the following aspects with our _No Wheel Inventions_ philosophy in mind:
