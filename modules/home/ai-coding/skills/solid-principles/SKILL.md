...
description: Provides comprehensive guidance for detecting and fixing SOLID violations. Should be used whenever working with object-oriented programming.
version: 0.1.0
---
